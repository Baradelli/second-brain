...
function AppShell() {
  ...
  const tabs: Tab[] = [
    ...
    { to: '/library', icon: <BookOpen size={20} strokeWidth={1.75} />, label: t('nav.library') },
    { to: '/capture', icon: <Plus size={26} strokeWidth={2} />, label: t('nav.capture'), isFab: true },
    { to: '/editor', icon: <PenLine size={20} strokeWidth={1.75} />, label: t('nav.editor') },
    { to: '/assistant', icon: <Sparkles size={20} strokeWidth={1.75} />, label: t('nav.assistant') },
  ];
